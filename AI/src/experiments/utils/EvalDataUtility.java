...
public class EvalDataUtility {
	...
	public static final List<String> evalAgents = Arrays.asList("Alpha-Beta", "MAST", "Ensemble", "MC-GRAVE",
			"Portfolio", "Progressive History", "UCT", "Ensemble 0", "Random", "Ensemble -1", "Ensemble -2");

	public static final List<String> evalGames = Arrays.asList("Starchess.lud", "DisPath.lud", "Ludus Anglicorum.lud",
			"Trax.lud", "Quixo.lud", "Banqi.lud", "Terhuchu.lud", "Katro.lud", "Surakarta.lud", "Mylna.lud",
			"Lines of Action.lud", "Ploy.lud", "Triad.lud", "Amazons.lud", "La Liebre Perseguida.lud", "Pylos.lud",
			"Chomp.lud", "Chameleon.lud", "Tawlbwrdd.lud", "Vela.lud", "Chuka.lud", "Hops-a-Daisy Generalized.lud",
			"Janggi.lud", "Patok.lud", "Toki.lud", "Omega.lud", "Gauntlet.lud", "Mehen.lud", "Mini Wars.lud",
			"Toki.lud", "Aralzaa.lud");
