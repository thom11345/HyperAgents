...
def load_agents_data():
    return pd.read_csv('data/gameAgents.csv')

def load_heuristics_data():
    return pd.read_csv('data/gameHeuristics.csv')

def load_concepts_data():
    return pd.read_csv('data/gameConceptsCompilation.csv')

def load_ludemes_data():
    return pd.read_csv('data/gameLudemes.csv')
